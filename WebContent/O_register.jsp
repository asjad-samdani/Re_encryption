...
%>
	...
	<section class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<form  action="O_RegisterPage" method="post"> 
  ...
  <option value="Female">Female</option>
            ...
            <!-- <input type="text" class="form-control" id="passwordsignup_confirm" placeholder="Gender" name="gender" required> -->
        </div>
        <div class="form-group" align="left">
...
<input type="date" class="form-control" name="bod"  placeholder="Birth Day">
         ...
         <div class="form-group" align="left">
            <input type="text" class="form-control" id="inputPassword" placeholder="Mobile No" name="Contact" required pattern="[7-9]{1}[0-9]{9}"  maxlength="10" title="* Mobile number with 7-9 and remaing 9 digit with 0-9">
        </div>
        <div align="left">
        ...
        <div align="right">
        Back to User Login Page: <a href="owner_signin.jsp"><button type="button" class="btn btn-link" >Sign In</button></a>        
        </div>
        </div>
      </div>
      </form>
