...
%>
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<h3>Our User Register</h3>
		</div>
		<div class="row">
			<div class="col-md-4">
				<img src="./images/index.jpg" alt="" style="height: 85%" class="img-responsive">
			</div>
			<div class="col-md-8">
				<form  action="RegisterPage" method="post"> 
      <div class="modal-content">
        <div class="modal-header"  style="background-color: gray;">
          <h5 class="modal-title">Registration Page</h5>
        </div>
...
<input type="date" class="form-control" name="bod"  placeholder="Birth Day">
        ...
        <div align="right">
        Back to User Login Page: <a href="Signin.jsp"><button type="button" class="btn btn-link" >Sign In</button></a>        
        </div>
        </div>
      </div>
      </form>
